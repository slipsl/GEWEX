...
if __name__ == "__main__":
  ...
  variable.idlfile = Path(str(variable.pyfile).replace("_SL2", "_05"))
  ...
  i_time = (args.date.day - 1) * nstep + 12
  ...
  # print(
  #   np.unravel_index(variable.pyvalues.argmin(), variable.pyvalues.shape),
  #   variable.pyvalues.min(),
  # )
  # print(
  #   np.unravel_index(variable.pyvalues.argmax(), variable.pyvalues.shape),
  #   variable.pyvalues.max()
  # )

  # print(
  #   np.unravel_index(variable.idlvalues.argmin(), variable.idlvalues.shape),
  #   variable.idlvalues.min(),
  # )
  # print(
  #   np.unravel_index(variable.idlvalues.argmax(), variable.idlvalues.shape),
  #   variable.idlvalues.max()
  # )



  print(
    variable.pyvalues[605, 660],
    variable.idlvalues[605, 660],
  )
  print(
    variable.pyvalues[133, 1320],
    variable.idlvalues[133, 1320],
  )
    ...
    for idx, (title, values) in enumerate(zip(titles, data)):
      ...
      if values is not None:
        ...
        print(
          ...
          Z.min(),
          # X[Z.argmin()], Y[Z.argmin()],
        )
        print(
          np.unravel_index(Z.argmax(), Z.shape),
          Z.max(),
          # X[Z.argmax()], Y[Z.argmax()],
        )
